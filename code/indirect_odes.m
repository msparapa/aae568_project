...
lambda3 = X(7);
lambda4 = X(8);
m = Chaser.m0 - Chaser.mdot*tau*tf;
...
dX_dt(1) = X(3);
dX_dt(2) = X(4);
dX_dt(3) = r*thetadot - 1/r^2 + Chaser.T/m*cos_gamma;
dX_dt(4) = -2*rdot*thetadot/r + Chaser.T/m/r*sin_gamma;
dX_dt(5) = -lambda3*(thetadot + 2/r^3) - lambda4*(2*rdot*thetadot/r^2 - Chaser.T/m/r^2*sin_gamma);
