...
for mc_i = 1:1
    ...
    Chaser.ts_opt =  1800/charT;%1800/charT;               % Non-dim time-of-flight for one "leg" between observations 
    ...
    Actual.X = [1; 0; 0; 1] + sqrt(Nav.P)*ones(4,1);    %Current state [r, theta, rdot, thetadot]
